...
import org.pillowfort.home.extensions.getCellCount
import org.pillowfort.home.helpers.MAX_CLICK_DURATION
...
class MyAppWidgetResizeFrame(context: Context, attrs: AttributeSet, defStyle: Int) : RelativeLayout(context, attrs, defStyle) {
    ...
    init {
        ...
        resizeWidgetLinePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = Color.WHITE
            strokeWidth = context.resources.getDimension(org.pillowfort.commons.R.dimen.tiny_margin)
