package org.pillowfort.home.views
...
import org.pillowfort.commons.extensions.adjustAlpha
...
import org.pillowfort.commons.extensions.statusBarHeight
...
import org.pillowfort.home.databinding.HomeScreenGridBinding
...
import org.pillowfort.home.helpers.WIDGET_HOST_ID
...
class HomeScreenGrid(context: Context, attrs: AttributeSet, defStyle: Int) :
    ...
    private var labelSideMargin =
        context.resources.getDimension(org.pillowfort.commons.R.dimen.small_margin).toInt()
    private var roundedCornerRadius =
        context.resources.getDimension(org.pillowfort.commons.R.dimen.activity_margin)
    private var folderPadding =
        context.resources.getDimension(org.pillowfort.commons.R.dimen.medium_margin)
    ...
    init {
        ...
        textPaint = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
            color = Color.WHITE
            textSize = context.resources.getDimension(org.pillowfort.commons.R.dimen.smaller_text_size)
        ...
        folderTitleTextPaint = TextPaint(Paint.ANTI_ALIAS_FLAG).apply {
            color = context.getProperTextColor()
            textSize = context.resources.getDimension(org.pillowfort.commons.R.dimen.medium_text_size)
        }

        dragShadowCirclePaint = Paint(Paint.ANTI_ALIAS_FLAG).apply {
            color = context.resources.getColor(org.pillowfort.commons.R.color.hint_white)
            strokeWidth = context.resources.getDimension(org.pillowfort.commons.R.dimen.small_margin)
        ...
        val sideMargin =
            context.resources.getDimension(org.pillowfort.commons.R.dimen.normal_margin).toInt()
        sideMargins.apply {
            ...
            if (potentialParent != null) {
                if (potentialParent.type == ITEM_TYPE_FOLDER) {
                    ...
                    val parentItem = potentialParent.copy(
                        ...
                        id = null,
                        title = resources.getString(org.pillowfort.commons.R.string.folder)
                    )
                    ensureBackgroundThread {
