...
import org.pillowfort.commons.dialogs.RadioGroupDialog
import org.pillowfort.commons.extensions.beGoneIf
import org.pillowfort.commons.extensions.beVisibleIf
import org.pillowfort.commons.extensions.getCustomizeColorsString
import org.pillowfort.commons.extensions.getProperPrimaryColor
import org.pillowfort.commons.extensions.isOrWasThankYouInstalled
import org.pillowfort.commons.extensions.launchMoreAppsFromUsIntent
import org.pillowfort.commons.extensions.launchPurchaseThankYouIntent
import org.pillowfort.commons.extensions.updateTextColors
import org.pillowfort.commons.extensions.viewBinding
import org.pillowfort.commons.helpers.NavigationIcon
import org.pillowfort.commons.helpers.isTiramisuPlus
import org.pillowfort.commons.models.FAQItem
import org.pillowfort.commons.models.RadioItem
import org.pillowfort.home.BuildConfig
import org.pillowfort.home.R
import org.pillowfort.home.databinding.ActivitySettingsBinding
import org.pillowfort.home.extensions.config
import org.pillowfort.home.helpers.MAX_COLUMN_COUNT
import org.pillowfort.home.helpers.MAX_ROW_COUNT
import org.pillowfort.home.helpers.MIN_COLUMN_COUNT
import org.pillowfort.home.helpers.MIN_ROW_COUNT
...
class SettingsActivity : SimpleActivity() {
    ...
    private fun refreshMenuItems() {
        binding.settingsToolbar.menu.apply {
            findItem(R.id.more_apps_from_us).isVisible =
                !resources.getBoolean(org.pillowfort.commons.R.bool.hide_google_relations)
        }
    }
                ...
                items.add(
                    RadioItem(
                        ...
                        title = resources.getQuantityString(
                            org.pillowfort.commons.R.plurals.column_counts, i, i
                        )
                    )
                )
            }
            ...
            for (i in MIN_ROW_COUNT..MAX_ROW_COUNT) {
                items.add(
                    RadioItem(
                        id = i,
                        title = resources.getQuantityString(
                            org.pillowfort.commons.R.plurals.row_counts, i, i
                        )
                    )
                )
            }
    ...
    private fun launchAbout() {
        ...
        if (!resources.getBoolean(org.pillowfort.commons.R.bool.hide_google_relations)) {
            faqItems.add(
                FAQItem(
                    title = org.pillowfort.commons.R.string.faq_2_title_commons,
                    text = org.pillowfort.commons.R.string.faq_2_text_commons
                )
            )
            faqItems.add(
                FAQItem(
                    title = org.pillowfort.commons.R.string.faq_6_title_commons,
                    text = org.pillowfort.commons.R.string.faq_6_text_commons
                )
            )
        }
