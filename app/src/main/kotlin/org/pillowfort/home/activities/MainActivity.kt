...
import org.pillowfort.commons.extensions.appLaunched
import org.pillowfort.commons.extensions.beVisible
import org.pillowfort.commons.extensions.getContrastColor
import org.pillowfort.commons.extensions.getPopupMenuTheme
import org.pillowfort.commons.extensions.getProperBackgroundColor
import org.pillowfort.commons.extensions.isPackageInstalled
import org.pillowfort.commons.extensions.onGlobalLayout
import org.pillowfort.commons.extensions.performHapticFeedback
import org.pillowfort.commons.extensions.realScreenSize
import org.pillowfort.commons.extensions.showErrorToast
import org.pillowfort.commons.extensions.showKeyboard
import org.pillowfort.commons.extensions.toast
import org.pillowfort.commons.extensions.viewBinding
import org.pillowfort.commons.helpers.DARK_GREY
import org.pillowfort.commons.helpers.ensureBackgroundThread
import org.pillowfort.commons.helpers.isQPlus
import org.pillowfort.home.BuildConfig
import org.pillowfort.home.R
import org.pillowfort.home.databinding.ActivityMainBinding
import org.pillowfort.home.databinding.AllAppsFragmentBinding
import org.pillowfort.home.databinding.WidgetsFragmentBinding
import org.pillowfort.home.dialogs.RenameItemDialog
import org.pillowfort.home.extensions.config
import org.pillowfort.home.extensions.getDrawableForPackageName
import org.pillowfort.home.extensions.getLabel
...
import org.pillowfort.home.extensions.isDefaultLauncher
import org.pillowfort.home.extensions.launchApp
import org.pillowfort.home.extensions.launchAppInfo
import org.pillowfort.home.extensions.launchersDB
import org.pillowfort.home.extensions.roleManager
import org.pillowfort.home.extensions.uninstallApp
import org.pillowfort.home.fragments.MyFragment
import org.pillowfort.home.helpers.ITEM_TYPE_FOLDER
import org.pillowfort.home.helpers.ITEM_TYPE_ICON
import org.pillowfort.home.helpers.ITEM_TYPE_SHORTCUT
import org.pillowfort.home.helpers.ITEM_TYPE_WIDGET
import org.pillowfort.home.helpers.IconCache
import org.pillowfort.home.helpers.REQUEST_ALLOW_BINDING_WIDGET
import org.pillowfort.home.helpers.REQUEST_CONFIGURE_WIDGET
import org.pillowfort.home.helpers.REQUEST_CREATE_SHORTCUT
import org.pillowfort.home.helpers.REQUEST_SET_DEFAULT
import org.pillowfort.home.helpers.UNINSTALL_APP_REQUEST_CODE
import org.pillowfort.home.interfaces.FlingListener
...
import org.pillowfort.home.receivers.LockDeviceAdminReceiver
...
class MainActivity : SimpleActivity(), FlingListener {
    ...
    private fun launchWallpapersIntent() {
        try {
            ...
            toast(org.pillowfort.commons.R.string.no_app_found)
        } catch (e: Exception) {
            showErrorToast(e)
        }
    }
